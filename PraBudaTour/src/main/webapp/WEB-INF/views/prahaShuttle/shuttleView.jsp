...
<html>
	...
	<main>
		...
		<form id="shuttleUpdateForm" method="post" action="/controller/shuttle/praha/shuttleUpdate">
			<div id="main_content" style="margin-top: 16px;">
				...
				<div class='row' id="password">
					<div class='input-field col s4' style='margin-bottom:-20px'>
						...
						<input id='password' name='password' type='password' readonly="readonly" value="${shuttleViewInfo.password}" class='validate updateform' placeholder='비밀번호 입력'>
		...
		<hr>
			...
			<div class="row">
				...
				<a class="waves-effect waves-light btn" onClick="submit();return false;" id="updateComplete">완료</a>
			</div>	<!--  button -->
		</div>	<!-- main_content -->
		</form>
		</div>	<!-- container -->
