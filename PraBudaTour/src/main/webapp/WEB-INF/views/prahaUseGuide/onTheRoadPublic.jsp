...
<!--Import jQuery before materialize.js-->
	...
	<main>
		...
		<img alt="public" src='<c:url value="/resources/images/selectonTheRoad.jpg"/>' style="margin-top:10px; padding-left:270px">
		<div>
		<label id="addr">Italska 2561/47 , 120 00 Praha 2-vinohrady</label>
		</div>
		<div id="map"></div>
		</td></tr>
		</table>
		...
		<script>
      function initMap() {
        var myLatLng = {lat: 50.082454, lng: 14.439288};
