   ...
   <a href="/controller/praha/prahaMain"><img src='<c:url value="/resources/images/logo.jpg"/>' id="logo"></a>
    <ul class="right on-med-and-down">
     <li><a href="/controller/praha/prahaGreetings/prahaGreetings">인사말</a></li>
      <li><a class="dropdown-button" href="#" data-activates="roomShow">둘러보기</a></li>
      <li><a class="dropdown-button" href="#"  data-activates="guide">이용안내</a></li>
      <li><a class="dropdown-button" href="#"  data-activates="reserve">예&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;약</a></li>
      <li><a class="dropdown-button" href="#" data-activates="tourInfo">여행정보</a></li>
      <li><a class="dropdown-button" href="#"  data-activates="community">커뮤니티</a></li>
...
<ul id="roomShow" class="dropdown-content">
   ...
   <li><a href="#!" style="background-color:tomato;color:white">프라하별관</a></li>
