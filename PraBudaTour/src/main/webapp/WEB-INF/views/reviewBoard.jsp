...
<!-- ############################### ##################################### -->	
	...
	<td colspan="2" class="centered" data-field="userState"><a href="/controller/praha/reviewInsertForm"><input class="waves-effect waves-light btn waves-input-wrapper" type="button" value="글쓰기"></a></td>
	</tr>
	</tbody>
</table>
	</div>
